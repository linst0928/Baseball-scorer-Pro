...
export const WASEDA_SYMBOL_REFERENCE: WasedaSymbolReference[] = [
  ...
  { id: "walk", category: "外圈", mark: "BB", title: "四壞球", placement: "外圈右上（藍字）", description: "非安打上壘事件；打者上一壘，其他跑者依規則推進。", example: "BB 上壘", tone: "blue" },
  { id: "intentional-walk", category: "外圈", mark: "DIB", title: "敬遠四壞", placement: "外圈右上（藍字）", description: "故意四壞球保送；打者上一壘。", example: "DIB 上壘", tone: "blue" },
  ...
  { id: "strikeout", category: "外圈", mark: "K", title: "三振", placement: "外圈右上（藍字）／菱形內圈", description: "打席以三振結束；右上角記 K，依該局出局順序在內圈標示 I、II 或 III。", example: "K → II", tone: "blue" },
  { id: "dropped-third-strike", category: "外圈", mark: "ꓘ", title: "不死三振", placement: "外圈右上（藍字）／菱形內圈", description: "第三好球未接捕但打者成功上一壘，以反向 K 標記。", example: "ꓘ 上壘", tone: "blue" },
  { id: "called-strikeout", category: "外圈", mark: "○K", title: "見逃三振", placement: "外圈右上（藍字）／菱形內圈", description: "第三好球為打者未揮棒時，以未揮好球符號加 K 記錄。", example: "○K → II", tone: "blue" },
  { id: "double-play", category: "外圈", mark: "DP", title: "雙殺", placement: "外圈右上／守備序列", description: "以 DP 搭配守備傳接記錄一個打席造成兩個出局。", example: "6ー4ー3 DP", tone: "blue" },
  { id: "triple-play", category: "外圈", mark: "TP", title: "三殺", placement: "外圈右上／守備序列", description: "以 TP 搭配守備傳接記錄一個打席造成三個出局。", example: "5ー4ー3 TP", tone: "blue" },
  { id: "obstruction", category: "外圈", mark: "OB", title: "妨礙跑壘", placement: "外圈右上（藍字）", description: "守備員妨礙跑者跑壘之判決。", example: "OB", tone: "blue" },
  { id: "catcher-interference", category: "外圈", mark: "2IF", title: "妨礙打擊", placement: "外圈右下（藍字）", description: "捕手妨礙打者擊球，記為 2IF。", example: "2IF", tone: "blue" },
  { id: "batter-interference", category: "外圈", mark: "IP2", title: "打者妨礙守備", placement: "外圈右下（藍字）", description: "打者妨礙捕手或守備員守備，記為 IP2。", example: "IP2", tone: "blue" },
  ...
  { id: "line", category: "守備／軌跡", mark: "—", title: "平飛球", placement: "菱形邊線／外圈", description: "用於描述平直飛出的擊球軌跡。", example: "—8 1B", tone: "navy" },
  { id: "ground", category: "守備／軌跡", mark: "︶", title: "滾地球", placement: "菱形邊線／外圈", description: "用於描述貼地滾動的擊球軌跡。", example: "︶6 5ー3", tone: "navy" },
  ...
  { id: "ground-out", category: "守備／軌跡", mark: "GO", title: "滾地出局", placement: "外圈右上；傳接另列右下", description: "結果區只記 GO；滾地軌跡、守備位置與傳接另記於外圈右下，內圈補該局出局順序。", example: "GO；右下：︶6ー3；內圈：I", tone: "navy" },
];
