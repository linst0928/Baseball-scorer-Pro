...
export const WASEDA_SYMBOL_REFERENCE: WasedaSymbolReference[] = [
  ...
  { id: "strikeout", category: "外圈", mark: "K", title: "三振", placement: "外圈右下（藍字）／菱形內圈", description: "打席以三振結束；右下角記 K，依該局出局順序在內圈標示 I、II 或 III。", example: "K → II", tone: "blue" },
  { id: "dropped-third-strike", category: "外圈", mark: "ꓘ", title: "不死三振", placement: "外圈右下（藍字）／菱形內圈", description: "第三好球未接捕但打者成功上一壘，以反向 ꓘ 標記（向量安全渲染）。", example: "ꓘ 上壘", tone: "blue" },
  { id: "called-strikeout", category: "外圈", mark: "○K", title: "見逃三振", placement: "外圈右下（藍字）／菱形內圈", description: "第三好球為打者未揮棒時，以未揮好球符號加 K 記錄。", example: "○K → II", tone: "blue" },
